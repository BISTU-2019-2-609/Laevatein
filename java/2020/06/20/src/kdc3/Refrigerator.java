...
public class Refrigerator extends Electrical implements Equipment {
    public Refrigerator() {
        super();
    }

    public Refrigerator(double price, double length, double width, double height, double consumption) {
